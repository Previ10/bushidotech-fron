...
export const DiscosSsdPage = () => {
  const { data: products, error, loading } = useGetProductQueryHook({ category: "Discos Solidos SSD" });
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-grow p-10 bg-gray-50">
        <h1 className="text-center text-4xl font-semibold mb-12 text-orange-500">Discos Solidos SSD</h1>
