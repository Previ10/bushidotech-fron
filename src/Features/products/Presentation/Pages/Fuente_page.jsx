...
export const FuentePage = () => {
  const { data: products, error, loading } = useGetProductQueryHook({ category: "Fuentes" });
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-grow p-10 bg-gray-50">
        <h1 className="text-center text-4xl font-semibold mb-12 text-orange-500">Fuentes</h1>
